...
2. Как добавить поля в таблицу товаров?  
    ...
    **Ответ:**  
    ...
    Нажать кнопку "Load schema". будет загружена XML схема тиблицы "shop_content". Нужно добавить в эту схему новые поля и нажать кнопку "Save schema".  
...
4. Почему не работает поиск на сайте?  
