...
Русский
Сниппет для вывода списка ресурсов. Предназначен специально для больших каталогов (например каталог товаров в интернет-магазине). Не использует xPDO, оптимизирована фильтрация по TV.
