 ...
 * @extends modRequest
 */
class giftCardsControllerRequest extends modRequest {
    public $giftCards = null;
    public $actionVar = 'action';
    public $defaultAction = 'home';

    function __construct(giftCards &$giftCards) {
        parent :: __construct($giftCards->modx);
    ...
    private function _respond() {
        ...
        $viewHeader = include $this->giftCards->config['corePath'].'controllers/mgr/header.php';

        $f = $this->giftCards->config['corePath'].'controllers/mgr/'.$this->action.'.php';
        if (file_exists($f)) {
